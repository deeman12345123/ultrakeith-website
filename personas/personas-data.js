...
var PERSONAS_DATABASE = [
    ...
    // EASY TO ADD MORE:
    // Just copy this format and add new personas:
    /*
    {
        number: "013", name: "New Persona Name", year: "2024", era: "new",
        age: "30", origin: "Somewhere",
        likes: "Things they like", 
        dislikes: "Things they don't like",
        quote: "Their famous quote...",
        biography: "Their story and background information...",
...
console.log('📋 Loaded ' + PERSONAS_DATABASE.length + ' personas from database');001", name: "Activity", year: "1984", era: "old", 
