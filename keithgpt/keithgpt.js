...
========================================`;
    ...
    triggerGuestAppearance() {
        ...
        // 60% chance they just lurk and leave, 40% chance they say something
    ...
    updateUserCount() {
        ...
        const allUsers = document.querySelectorAll('#allUsersList .user-item').length;
        const total = mainPersonas + allUsers;
